...
local maxAmmo=10 --how much ammo u get when u reload (setting it to huge numbers isnt nice)
local shootingSpeed=1 --speed of the shooting animation
...
local reloadSpeed=1 --speed of the reload animation
...
local recoilXcatch=math.rad(20) --how fast ur X axis recoil velocity will go back to 0
local recoilVelocityYfrom=math.rad(15) --highest simulated camera Y axis rotvelocity when u shoot
local recoilVelocityYto=math.rad(-5) --lowest simulated camera Y axis rotvelocity when u shoot
local recoilYcatch=math.rad(20) --how fast ur Y axis recoil velocity will go back to 0
...
local maxHealth=1 --client sided health bars max health
